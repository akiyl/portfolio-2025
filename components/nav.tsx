    ...
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50 w-full md:hidden bg-[#121212]">
        <div className="w-full flex items-center justify-center">
          <div className="w-[90%] max-w-[800px] flex items-center justify-between px-3 bg-[#121212]">
            <a
              href="/"
              aria-label="About"
      ...
      <div className="hidden md:block fixed bottom-0 left-0 right-0 z-50 bg-[#121212]/80 backdrop-blur-sm">
