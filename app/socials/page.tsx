const Socials = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen animate-fade-in transition-all duration-200 ">
      <div className="lg:grid-cols-3 lg:grid lg:gap-4 grid grid-cols-1 gap-2 p-4 ">
        <div
        ...
        <div
          className={`group flex items-center justify-center gap-2 mb-4 animate-fade-in transition-all duration-500  delay-200 animation-delay-1000`}
        >
